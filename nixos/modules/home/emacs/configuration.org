...
#+BEGIN_SRC emacs-lisp
  (setq org-agenda-files '("~/Dropbox/org/in/inbox.org" "~/schedule.org"))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package org-gcal
    :ensure t
    :config
    (setq org-gcal-client-id "663970852062-6fj12lco2g8t3tuoc5uhgc4f28c6a9i7.apps.googleusercontent.com"
          org-gcal-client-secret "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"
